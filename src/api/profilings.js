...
exports.metadata = async function () {
    const res = await this.api.head("/profilings");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/profilings/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (profiling = {}) {
    const res = await this.api.post("/profilings", profiling);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/profilings/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/profilings", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/profilings/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/profilings/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/profilings/import", values);
    return res.status === 200;
};
