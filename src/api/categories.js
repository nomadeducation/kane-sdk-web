...
exports.metadata = async function () {
    const res = await this.api.head("/categories");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/categories/${id}`);
...
exports.create = async function (category = {}) {
    const res = await this.api.post("/categories", category);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/categories/${id}`);
    return res.data;
};
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/categories/${id}`, infos);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/categories/import", values);
    return res.status === 200;
};
