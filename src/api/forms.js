...
exports.metadata = async function () {
    const res = await this.api.head("/forms");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/forms/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (form = {}) {
    const res = await this.api.post("/forms", form);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/forms/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/forms", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/forms/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/forms/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/forms/import", values);
    return res.status === 200;
};
