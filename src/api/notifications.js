...
exports.metadata = async function () {
    const res = await this.api.head("/notifications");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/notifications/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (notification = {}) {
    const res = await this.api.post("/notifications", notification);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/notifications/${id}`);
    return res.data;
};
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/notifications/${id}`, infos);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/notifications/import", values);
    return res.status === 200;
};
