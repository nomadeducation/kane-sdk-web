...
exports.metadata = async function () {
    const res = await this.api.head("/degreefields");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/degreefields/${id}`);
...
exports.create = async function (branch = {}) {
    const res = await this.api.post("/degreefields", branch);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/degreefields/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/degreefields", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/degreefields/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/degreefields/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/degreefields/import", values);
    return res.status === 200;
};
