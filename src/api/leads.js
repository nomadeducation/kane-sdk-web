...
exports.metadata = async function () {
    const res = await this.api.head("/leads");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/leads/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (lead = {}) {
    const res = await this.api.post("/leads", lead);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/leads/${id}`);
    return res.data;
};
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/leads/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/leads/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/leads/import", values);
    return res.status === 200;
};
