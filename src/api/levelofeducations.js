...
exports.metadata = async function () {
    const res = await this.api.head("/levelofeducations");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/levelofeducations/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (loe = {}) {
    const res = await this.api.post("/levelofeducations", loe);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/levelofeducations/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/levelofeducations", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/levelofeducations/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/levelofeducations/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/levelofeducations/import", values);
    return res.status === 200;
};
