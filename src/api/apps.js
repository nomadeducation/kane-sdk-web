...
exports.metadata = async function () {
    const res = await this.api.head("/apps");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/apps/${id}`);
...
exports.create = async function (app = {}) {
    const res = await this.api.post("/apps", app);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/apps/${id}`);
    return res.data;
};
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/apps/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/apps/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/apps/import", values);
    return res.status === 200;
};
