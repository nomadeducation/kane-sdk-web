...
exports.metadata = async function () {
    const res = await this.api.head("/sponsorinfos");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/sponsorinfos/${id}`);
    return res.status === 200;
};

/**
 * @param {Object} sponsorinfo
 * @returns {Promise<*>}
 */
exports.create = async function (sponsorinfo = {}) {
    const res = await this.api.post("/sponsorinfos", sponsorinfo);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/sponsorinfos/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/sponsorinfos", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/sponsorinfos/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/sponsorinfos/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/sponsorinfos/import", values);
    return res.status === 200;
};
