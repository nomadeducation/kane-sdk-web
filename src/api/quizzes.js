...
exports.metadata = async function () {
    const res = await this.api.head("/quizzes");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/quizzes/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (quiz = {}) {
    const res = await this.api.post("/quizzes", quiz);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/quizzes/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/quizzes", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/quizzes/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/quizzes/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/quizzes/import", values);
    return res.status === 200;
};
