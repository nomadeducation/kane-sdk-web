...
exports.metadata = async function () {
    const res = await this.api.head("/questions");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/questions/${id}`);
...
exports.create = async function (question = {}) {
    const res = await this.api.post("/questions", question);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/questions/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/questions", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/questions/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/questions/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/questions/import", values);
    return res.status === 200;
};
