...
exports.metadata = async function () {
    const res = await this.api.head("/lv1s");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/lv1s/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (lv1 = {}) {
    const res = await this.api.post("/lv1s", lv1);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/lv1s/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/lv1s", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/lv1s/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/lv1s/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/lv1s/import", values);
    return res.status === 200;
};
