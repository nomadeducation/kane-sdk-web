...
exports.metadata = async function () {
    const res = await this.api.head("/jobs");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/jobs/${id}`);
...
exports.create = async function (job = {}) {
    const res = await this.api.post("/jobs", job);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/jobs/${id}`);
    return res.data;
};
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/jobs/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/jobs/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/jobs/import", values);
    return res.status === 200;
};
