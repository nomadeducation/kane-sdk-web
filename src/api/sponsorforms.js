...
exports.metadata = async function () {
    const res = await this.api.head("/sponsorforms");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/sponsorforms/${id}`);
    return res.status === 200;
};

/**
 * @param {Object} sponsorform
 * @returns {Promise<*>}
 */
exports.create = async function (sponsorform = {}) {
    const res = await this.api.post("/sponsorforms", sponsorform);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/sponsorforms/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/sponsorforms", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/sponsorforms/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/sponsorforms/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/sponsorforms/import", values);
    return res.status === 200;
};
