...
exports.metadata = async function () {
    const res = await this.api.head("/schools");
...
exports.exists = async function (id) {
    const res = await this.api.head(`/schools/${id}`);
 ...
 * @returns {Promise<*>}
 */
exports.create = async function (school = {}) {
    const res = await this.api.post("/schools", school);
    return res.data;
};
...
exports.get = async function (id) {
    const res = await this.api.get(`/schools/${id}`);
    return res.data;
};
...
exports.list = async function (offset = 0, limit = 100) {
    ...
    const res = await this.api.get("/schools", {
        headers: {
...
exports.update = async function (id, infos = {}) {
    const res = await this.api.patch(`/schools/${id}`, infos);
    return res.status === 200;
};
...
exports.remove = async function (id) {
    const res = await this.api.delete(`/schools/${id}`);
    return res.status === 200;
};
...
exports.import = async function (values) {
    const res = await this.api.post("/schools/import", values);
    return res.status === 200;
};
